defmodule Renaissance.Auth do
  ...
  # TODO: Why is this a scan? Where's the index?
  def find_user_by_authid(authid), do: Repo.get_by(User, [{:authid, authid}], scan: true)
